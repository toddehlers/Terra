...
void Plotter::refreshPixmap(int value)
{
    ...
    update();
    if(value == 1)
    	pixmap.save("../output/plots/image_2D_isotherm_topography.png", "PNG");
    else if(value == 2)
    {
...
void Plotter::drawGrid(QPainter *painter)
{
  ...
  painter->drawRect(rect);
	...
	painter->drawText(Margin, Margin - 30, width() - 2 * Margin, 20, AlignHCenter | AlignTop,
                    "STEADY STATE ISOTHERMS, EXHUMATION RATE = " + exhumation + " mm/yr");
  
	painter->drawText(Margin, Margin + height() - 65, width() - 2 * Margin, 20, AlignHCenter | AlignBottom,
...
void Plotter::drawCurves(QPainter *painter)
{
  ...
  while(it != curveMap.end()) {
	...
	pen.setColor(black);
	painter->setPen(pen);
	painter->drawText(x1 + 45, y1 + 15, "Topography");
	...
	pen.setColor(black);
	painter->setPen(pen);
	painter->drawText(x1 + 45, y1 + 30, iso_1);
	...
	pen.setColor(black);
	painter->setPen(pen);
	painter->drawText(x1 + 45, y1 + 45, iso_2);
	...
	pen.setColor(black);
	painter->setPen(pen);
	painter->drawText(x1 + 45, y1 + 60, iso_3);
