...
void Plotter::refreshPixmap(int value)
{
  ...
  update();
  if(value == 1)
    pixmap.save("../output/plots/image_temp_hist.png", "PNG");
  else if(value == 2)
  {
...
void Plotter::drawGrid(QPainter *painter)
{
  ...
  painter->drawRect(rect);
	...
	dark.setWidth(3);
	painter->setPen(dark);
	painter->drawText(Margin, Margin - 30, width() - 2 * Margin, 20, AlignHCenter | AlignTop, "COOLING HISTORY: 1D TRANSIENT EROSION, EXPOSED AT = " + exhumation + " Million yrs");
